...
import functools
from .ghost_bn import GhostBN2D_ADV
...
# print(global_val.gbn_forward_time)

to_0 = partial(to_bn, status='bn0')
to_1 = partial(to_bn, status='bn1')
to_2 = partial(to_bn, status='bn2')
to_3 = partial(to_bn, status='bn3')
if gbn_forward_time == 8:
    to_4 = partial(to_bn, status='bn4')
    to_5 = partial(to_bn, status='bn5')
    to_6 = partial(to_bn, status='bn6')
    to_7 = partial(to_bn, status='bn7')
